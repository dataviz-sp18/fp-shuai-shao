...
library(tidyverse)
library(haven)
dataall <- read_sav("Vancouver+Hangzhou_2018April.sav") %>% select(1:41)
```
...
```{r classification, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r justifications, echo=FALSE, warning=FALSE}
